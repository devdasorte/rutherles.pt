                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="share_with_public" class="form-check-input" id="share_with_public">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="show_landing_page_announcebar" class="form-check-input" id="show_landing_page_announcebar">
