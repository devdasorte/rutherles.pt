...
<style>
    ...
    .sorteio-numeros-selecionados {
        ...
        transition: all .3s ease-in-out, bottom .3s ease-in-out;
...
<div class="container app-main">
        ...
        <div
            ...
            <div class="SorteioTpl_imagemContainer__2-pl4 col-auto">
                ...
                <button class="carousel-control-prev" type="button"
                    data-bs-target="#carouselSorteio<?php echo $id; ?>" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon"></span>
                </button>
                <button class="carousel-control-next" type="button"
                    data-bs-target="#carouselSorteio<?php echo $id; ?>" data-bs-slide="next">
    ...
    <div class="sorteio-share d-flex mb-2 justify-content-between align-items-center">
        ...
        <div class="item d-flex align-items-center">
            ...
            <a href="https://api.whatsapp.com/send/?text=<?= $name ?>%21%21%3A+<?= base_url ?>sorteio/<?= $slug ?>&type=custom_url&app_absent=0"
                target="_blank">
    ...
    <div class="numeros-list row row-cols-5 mb-4 row-gutter-sm"></div>
    <?php } ?>
    <?php
...
<div class="modal fade" id="modal-afiliado-link" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-2">
                                <input onkeyup="leowpMask(this);" maxlength="15" class="form-control"
                                    aria-label="Número de telefone" id="phone" name="phone" required=""
                                    value="">
        ...
        <div class="modal-dialog modal-fullscreen-sm-down modal-dialog-centered">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body checkout">
                    ...
                    <button type="button"
                        class="btn btn-link btn-sm text-secondary text-decoration-none w-100 my-2"><a
    ...
    <button id="aviso_sorteio" data-bs-toggle="modal" data-bs-target="#modal-aviso"
        class="btn btn-success w-100 py-2" style="display:none"></button>
    ...
    <script>
        ...
        $('.cotas-checkout').on('click', '.cota', function() {
            ...
            $('.numeros-list .numero-template[data-cota="' + valor + '"]').removeClass('numero-template-selected')
                .addClass('bg-cota');
            $('.numeros-list .numero-template[data-cota="' + valor + '"]').find('.blur').hide();
        });
